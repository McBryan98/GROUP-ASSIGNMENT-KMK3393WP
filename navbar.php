  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav" style="border: 5px solid;">
        ...
        <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Link To Contributor e-Portfolio <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li role="separator" class="divider"></li>
            <li><a href="https://alfeezanamran.github.io/Personal_Resume/resume_alfeezan.html">68459</a></li>
            <li role="separator" class="divider"></li>
        </ul></li>
        </li>
      </ul>
